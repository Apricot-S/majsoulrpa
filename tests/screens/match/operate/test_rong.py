...
from majsoulrpa.screens.match import HuleEvent, MatchScreen, RongOperation
...
def test_operate_enables_auto_hule_and_waits_for_rong(
    ...
    messages = _message_queue(
        ...
        _live_new_round_action(step=0, ju=2, scores=old_scores),
        _live_discard_action(
            step=1,
            seat=1,
            tile="0m",
