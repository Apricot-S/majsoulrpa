...
class AccountActivityUpdate(_message.Message):
    __slots__ = ("mine_data", "rpg_data", "feed_data", "spot_data", "friend_gift_data", "upgrade_data", "gacha_data", "simulation_data", "combining_data", "village_data", "festival_data", "island_data", "story_data", "choose_up_data", "simulation_v2_data", "quest_crew_data", "shoot_data", "bingo_data", "snowball_data", "choose_group_up_data", "mmo_data", "activity_buff")
    class ActivityBuffDataArrayDirty(_message.Message):
        __slots__ = ("dirty", "value")
        DIRTY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        dirty: bool
        value: _containers.RepeatedCompositeFieldContainer[ActivityBuffData]
        def __init__(self, dirty: _Optional[bool] = ..., value: _Optional[_Iterable[_Union[ActivityBuffData, _Mapping]]] = ...) -> None: ...
    ...
    CHOOSE_GROUP_UP_DATA_FIELD_NUMBER: _ClassVar[int]
    MMO_DATA_FIELD_NUMBER: _ClassVar[int]
...
class ActionSubmit(_message.Message):
    __slots__ = ("submits",)
    SUBMITS_FIELD_NUMBER: _ClassVar[int]
    submits: _containers.RepeatedCompositeFieldContainer[SubmitInfo]
    def __init__(self, submits: _Optional[_Iterable[_Union[SubmitInfo, _Mapping]]] = ...) -> None: ...

class ActionTake(_message.Message):
    __slots__ = ("takes", "tingpais0", "tingpais1", "operation")
    TAKES_FIELD_NUMBER: _ClassVar[int]
    TINGPAIS0_FIELD_NUMBER: _ClassVar[int]
    TINGPAIS1_FIELD_NUMBER: _ClassVar[int]
    OPERATION_FIELD_NUMBER: _ClassVar[int]
    takes: _containers.RepeatedCompositeFieldContainer[TakeInfo]
    tingpais0: _containers.RepeatedCompositeFieldContainer[TingPaiDiscardInfo]
    tingpais1: _containers.RepeatedCompositeFieldContainer[TingPaiInfo]
    operation: OptionalOperationList
    def __init__(self, takes: _Optional[_Iterable[_Union[TakeInfo, _Mapping]]] = ..., tingpais0: _Optional[_Iterable[_Union[TingPaiDiscardInfo, _Mapping]]] = ..., tingpais1: _Optional[_Iterable[_Union[TingPaiInfo, _Mapping]]] = ..., operation: _Optional[_Union[OptionalOperationList, _Mapping]] = ...) -> None: ...
...
class ActivityChooseGroupData(_message.Message):
    __slots__ = ("activity_id", "chest_id", "selection_id")
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    chest_id: int
    selection_id: int
    def __init__(self, activity_id: _Optional[int] = ..., chest_id: _Optional[int] = ..., selection_id: _Optional[int] = ...) -> None: ...
...
class ActivityMMOData(_message.Message):
    __slots__ = ("activity_id", "character", "team", "bag", "map", "support")
    class ActivityMMOCharacterData(_message.Message):
        __slots__ = ("character_id", "equipments")
        CHARACTER_ID_FIELD_NUMBER: _ClassVar[int]
        EQUIPMENTS_FIELD_NUMBER: _ClassVar[int]
        character_id: int
        equipments: _containers.RepeatedScalarFieldContainer[int]
        def __init__(self, character_id: _Optional[int] = ..., equipments: _Optional[_Iterable[int]] = ...) -> None: ...
    class ActivityMMOTeamData(_message.Message):
        __slots__ = ("members", "friend_list", "friend_list_expire", "random_friends", "daily_update_time", "npc_list")
        MEMBERS_FIELD_NUMBER: _ClassVar[int]
        FRIEND_LIST_FIELD_NUMBER: _ClassVar[int]
        FRIEND_LIST_EXPIRE_FIELD_NUMBER: _ClassVar[int]
        RANDOM_FRIENDS_FIELD_NUMBER: _ClassVar[int]
        DAILY_UPDATE_TIME_FIELD_NUMBER: _ClassVar[int]
        NPC_LIST_FIELD_NUMBER: _ClassVar[int]
        members: _containers.RepeatedCompositeFieldContainer[ActivityMMOTeamMember]
        friend_list: _containers.RepeatedCompositeFieldContainer[MMOActivityTeamCandidateData]
        friend_list_expire: int
        random_friends: _containers.RepeatedCompositeFieldContainer[MMOActivityTeamCandidateData]
        daily_update_time: int
        npc_list: _containers.RepeatedCompositeFieldContainer[MMOActivityTeamCandidateData]
        def __init__(self, members: _Optional[_Iterable[_Union[ActivityMMOTeamMember, _Mapping]]] = ..., friend_list: _Optional[_Iterable[_Union[MMOActivityTeamCandidateData, _Mapping]]] = ..., friend_list_expire: _Optional[int] = ..., random_friends: _Optional[_Iterable[_Union[MMOActivityTeamCandidateData, _Mapping]]] = ..., daily_update_time: _Optional[int] = ..., npc_list: _Optional[_Iterable[_Union[MMOActivityTeamCandidateData, _Mapping]]] = ...) -> None: ...
    class ActivityMMOBagData(_message.Message):
        __slots__ = ("equipments", "total_gain_count", "total_fusion_count", "random_record")
        class ActivityMMORandomRecord(_message.Message):
            __slots__ = ("rarity", "count")
            RARITY_FIELD_NUMBER: _ClassVar[int]
            COUNT_FIELD_NUMBER: _ClassVar[int]
            rarity: int
            count: int
            def __init__(self, rarity: _Optional[int] = ..., count: _Optional[int] = ...) -> None: ...
        EQUIPMENTS_FIELD_NUMBER: _ClassVar[int]
        TOTAL_GAIN_COUNT_FIELD_NUMBER: _ClassVar[int]
        TOTAL_FUSION_COUNT_FIELD_NUMBER: _ClassVar[int]
        RANDOM_RECORD_FIELD_NUMBER: _ClassVar[int]
        equipments: _containers.RepeatedCompositeFieldContainer[ActivityMMOEquipmentData]
        total_gain_count: int
        total_fusion_count: int
        random_record: _containers.RepeatedCompositeFieldContainer[ActivityMMOData.ActivityMMOBagData.ActivityMMORandomRecord]
        def __init__(self, equipments: _Optional[_Iterable[_Union[ActivityMMOEquipmentData, _Mapping]]] = ..., total_gain_count: _Optional[int] = ..., total_fusion_count: _Optional[int] = ..., random_record: _Optional[_Iterable[_Union[ActivityMMOData.ActivityMMOBagData.ActivityMMORandomRecord, _Mapping]]] = ...) -> None: ...
    class ActivityMMOMapData(_message.Message):
        __slots__ = ("level", "random_seed", "won", "failed")
        LEVEL_FIELD_NUMBER: _ClassVar[int]
        ...
        won: int
        failed: int
        def __init__(self, level: _Optional[int] = ..., random_seed: _Optional[int] = ..., won: _Optional[int] = ..., failed: _Optional[int] = ...) -> None: ...
    class ActivityMMOSupportData(_message.Message):
        __slots__ = ("last_receive_time", "most_supporter", "receive_support_count", "support_record")
        LAST_RECEIVE_TIME_FIELD_NUMBER: _ClassVar[int]
        MOST_SUPPORTER_FIELD_NUMBER: _ClassVar[int]
        RECEIVE_SUPPORT_COUNT_FIELD_NUMBER: _ClassVar[int]
        SUPPORT_RECORD_FIELD_NUMBER: _ClassVar[int]
        last_receive_time: int
        most_supporter: ActivityMMOSupportRecord
        receive_support_count: int
        support_record: _containers.RepeatedCompositeFieldContainer[ActivityMMOSupportRecord]
        def __init__(self, last_receive_time: _Optional[int] = ..., most_supporter: _Optional[_Union[ActivityMMOSupportRecord, _Mapping]] = ..., receive_support_count: _Optional[int] = ..., support_record: _Optional[_Iterable[_Union[ActivityMMOSupportRecord, _Mapping]]] = ...) -> None: ...
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    CHARACTER_FIELD_NUMBER: _ClassVar[int]
    ...
    activity_id: int
    character: ActivityMMOData.ActivityMMOCharacterData
    team: ActivityMMOData.ActivityMMOTeamData
    bag: ActivityMMOData.ActivityMMOBagData
    map: ActivityMMOData.ActivityMMOMapData
    support: ActivityMMOData.ActivityMMOSupportData
    def __init__(self, activity_id: _Optional[int] = ..., character: _Optional[_Union[ActivityMMOData.ActivityMMOCharacterData, _Mapping]] = ..., team: _Optional[_Union[ActivityMMOData.ActivityMMOTeamData, _Mapping]] = ..., bag: _Optional[_Union[ActivityMMOData.ActivityMMOBagData, _Mapping]] = ..., map: _Optional[_Union[ActivityMMOData.ActivityMMOMapData, _Mapping]] = ..., support: _Optional[_Union[ActivityMMOData.ActivityMMOSupportData, _Mapping]] = ...) -> None: ...

class ActivityMMODataChanges(_message.Message):
    __slots__ = ("activity_id", "character", "team", "bag", "map", "support")
    class ActivityMMOCharacterDataChanges(_message.Message):
        __slots__ = ("character_id", "equipments")
        CHARACTER_ID_FIELD_NUMBER: _ClassVar[int]
        EQUIPMENTS_FIELD_NUMBER: _ClassVar[int]
        character_id: UInt32Dirty
        equipments: UInt32ArrayDirty
        def __init__(self, character_id: _Optional[_Union[UInt32Dirty, _Mapping]] = ..., equipments: _Optional[_Union[UInt32ArrayDirty, _Mapping]] = ...) -> None: ...
    class ActivityMMOTeamMemberArrayDirty(_message.Message):
        __slots__ = ("dirty", "value")
        DIRTY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        dirty: bool
        value: _containers.RepeatedCompositeFieldContainer[ActivityMMOTeamMember]
        def __init__(self, dirty: _Optional[bool] = ..., value: _Optional[_Iterable[_Union[ActivityMMOTeamMember, _Mapping]]] = ...) -> None: ...
    class ActivityMMOTeamDataChanges(_message.Message):
        __slots__ = ("members",)
        MEMBERS_FIELD_NUMBER: _ClassVar[int]
        members: ActivityMMODataChanges.ActivityMMOTeamMemberArrayDirty
        def __init__(self, members: _Optional[_Union[ActivityMMODataChanges.ActivityMMOTeamMemberArrayDirty, _Mapping]] = ...) -> None: ...
    class ActivityMMOEquipmentsArrayDirty(_message.Message):
        __slots__ = ("dirty", "value")
        DIRTY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        dirty: bool
        value: _containers.RepeatedCompositeFieldContainer[ActivityMMOEquipmentData]
        def __init__(self, dirty: _Optional[bool] = ..., value: _Optional[_Iterable[_Union[ActivityMMOEquipmentData, _Mapping]]] = ...) -> None: ...
    class ActivityMMOBagDataChanges(_message.Message):
        __slots__ = ("equipments", "total_gain_count", "total_fusion_count")
        EQUIPMENTS_FIELD_NUMBER: _ClassVar[int]
        TOTAL_GAIN_COUNT_FIELD_NUMBER: _ClassVar[int]
        TOTAL_FUSION_COUNT_FIELD_NUMBER: _ClassVar[int]
        equipments: ActivityMMODataChanges.ActivityMMOEquipmentsArrayDirty
        total_gain_count: UInt32Dirty
        total_fusion_count: UInt32Dirty
        def __init__(self, equipments: _Optional[_Union[ActivityMMODataChanges.ActivityMMOEquipmentsArrayDirty, _Mapping]] = ..., total_gain_count: _Optional[_Union[UInt32Dirty, _Mapping]] = ..., total_fusion_count: _Optional[_Union[UInt32Dirty, _Mapping]] = ...) -> None: ...
    class ActivityMMOMapDataChanges(_message.Message):
        __slots__ = ("level", "random_seed", "won", "failed")
        LEVEL_FIELD_NUMBER: _ClassVar[int]
        RANDOM_SEED_FIELD_NUMBER: _ClassVar[int]
        WON_FIELD_NUMBER: _ClassVar[int]
        FAILED_FIELD_NUMBER: _ClassVar[int]
        level: UInt32Dirty
        random_seed: UInt32Dirty
        won: UInt32Dirty
        failed: UInt32Dirty
        def __init__(self, level: _Optional[_Union[UInt32Dirty, _Mapping]] = ..., random_seed: _Optional[_Union[UInt32Dirty, _Mapping]] = ..., won: _Optional[_Union[UInt32Dirty, _Mapping]] = ..., failed: _Optional[_Union[UInt32Dirty, _Mapping]] = ...) -> None: ...
    class ActivityMMOSupportDataChanges(_message.Message):
        __slots__ = ("last_receive_time", "most_supporter", "receive_support_count")
        LAST_RECEIVE_TIME_FIELD_NUMBER: _ClassVar[int]
        MOST_SUPPORTER_FIELD_NUMBER: _ClassVar[int]
        RECEIVE_SUPPORT_COUNT_FIELD_NUMBER: _ClassVar[int]
        last_receive_time: UInt32Dirty
        most_supporter: ActivityMMOSupportRecordDirty
        receive_support_count: UInt32Dirty
        def __init__(self, last_receive_time: _Optional[_Union[UInt32Dirty, _Mapping]] = ..., most_supporter: _Optional[_Union[ActivityMMOSupportRecordDirty, _Mapping]] = ..., receive_support_count: _Optional[_Union[UInt32Dirty, _Mapping]] = ...) -> None: ...
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    CHARACTER_FIELD_NUMBER: _ClassVar[int]
    TEAM_FIELD_NUMBER: _ClassVar[int]
    BAG_FIELD_NUMBER: _ClassVar[int]
    ...
    SUPPORT_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    character: ActivityMMODataChanges.ActivityMMOCharacterDataChanges
    team: ActivityMMODataChanges.ActivityMMOTeamDataChanges
    bag: ActivityMMODataChanges.ActivityMMOBagDataChanges
    map: ActivityMMODataChanges.ActivityMMOMapDataChanges
    support: ActivityMMODataChanges.ActivityMMOSupportDataChanges
    def __init__(self, activity_id: _Optional[int] = ..., character: _Optional[_Union[ActivityMMODataChanges.ActivityMMOCharacterDataChanges, _Mapping]] = ..., team: _Optional[_Union[ActivityMMODataChanges.ActivityMMOTeamDataChanges, _Mapping]] = ..., bag: _Optional[_Union[ActivityMMODataChanges.ActivityMMOBagDataChanges, _Mapping]] = ..., map: _Optional[_Union[ActivityMMODataChanges.ActivityMMOMapDataChanges, _Mapping]] = ..., support: _Optional[_Union[ActivityMMODataChanges.ActivityMMOSupportDataChanges, _Mapping]] = ...) -> None: ...

class ActivityMMOEquipmentData(_message.Message):
    __slots__ = ("id", "stack")
    ID_FIELD_NUMBER: _ClassVar[int]
    STACK_FIELD_NUMBER: _ClassVar[int]
    id: int
    stack: int
    def __init__(self, id: _Optional[int] = ..., stack: _Optional[int] = ...) -> None: ...

class ActivityMMOSupportRecord(_message.Message):
    __slots__ = ("id", "count", "type", "character_id", "equipments")
    ID_FIELD_NUMBER: _ClassVar[int]
    COUNT_FIELD_NUMBER: _ClassVar[int]
    TYPE_FIELD_NUMBER: _ClassVar[int]
    CHARACTER_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    character_id: int
    equipments: _containers.RepeatedScalarFieldContainer[int]
    def __init__(self, id: _Optional[int] = ..., count: _Optional[int] = ..., type: _Optional[int] = ..., character_id: _Optional[int] = ..., equipments: _Optional[_Iterable[int]] = ...) -> None: ...

class ActivityMMOSupportRecordDirty(_message.Message):
    __slots__ = ("dirty", "value")
    DIRTY_FIELD_NUMBER: _ClassVar[int]
    VALUE_FIELD_NUMBER: _ClassVar[int]
    dirty: bool
    value: ActivityMMOSupportRecord
    def __init__(self, dirty: _Optional[bool] = ..., value: _Optional[_Union[ActivityMMOSupportRecord, _Mapping]] = ...) -> None: ...

class ActivityMMOTeamMember(_message.Message):
    __slots__ = ("character_id", "equipments", "id", "type")
    CHARACTER_ID_FIELD_NUMBER: _ClassVar[int]
    EQUIPMENTS_FIELD_NUMBER: _ClassVar[int]
    ID_FIELD_NUMBER: _ClassVar[int]
    TYPE_FIELD_NUMBER: _ClassVar[int]
    ...
    id: int
    type: int
    def __init__(self, character_id: _Optional[int] = ..., equipments: _Optional[_Iterable[int]] = ..., id: _Optional[int] = ..., type: _Optional[int] = ...) -> None: ...

class ActivityMarathonCheckData(_message.Message):
    __slots__ = ("round", "item", "tile", "tick", "point", "time_end")
    ...
    point: int
    time_end: int
    def __init__(self, round: _Optional[int] = ..., item: _Optional[_Iterable[int]] = ..., tile: _Optional[str] = ..., tick: _Optional[int] = ..., point: _Optional[int] = ..., time_end: _Optional[int] = ...) -> None: ...

class ActivityMarathonData(_message.Message):
    __slots__ = ("activity_id", "highest_record", "race_data", "history")
    class MarathonRaceData(_message.Message):
        __slots__ = ("id", "random_seed", "start_time")
        ID_FIELD_NUMBER: _ClassVar[int]
        RANDOM_SEED_FIELD_NUMBER: _ClassVar[int]
        START_TIME_FIELD_NUMBER: _ClassVar[int]
        id: str
        random_seed: int
        start_time: int
        def __init__(self, id: _Optional[str] = ..., random_seed: _Optional[int] = ..., start_time: _Optional[int] = ...) -> None: ...
    class MarathonRaceHistory(_message.Message):
        __slots__ = ("race_data", "record")
        RACE_DATA_FIELD_NUMBER: _ClassVar[int]
        RECORD_FIELD_NUMBER: _ClassVar[int]
        race_data: ActivityMarathonData.MarathonRaceData
        record: MarathonGameRecord
        def __init__(self, race_data: _Optional[_Union[ActivityMarathonData.MarathonRaceData, _Mapping]] = ..., record: _Optional[_Union[MarathonGameRecord, _Mapping]] = ...) -> None: ...
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    HIGHEST_RECORD_FIELD_NUMBER: _ClassVar[int]
    RACE_DATA_FIELD_NUMBER: _ClassVar[int]
    HISTORY_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    highest_record: MarathonGameRecord
    race_data: ActivityMarathonData.MarathonRaceData
    history: _containers.RepeatedCompositeFieldContainer[ActivityMarathonData.MarathonRaceHistory]
    def __init__(self, activity_id: _Optional[int] = ..., highest_record: _Optional[_Union[MarathonGameRecord, _Mapping]] = ..., race_data: _Optional[_Union[ActivityMarathonData.MarathonRaceData, _Mapping]] = ..., history: _Optional[_Iterable[_Union[ActivityMarathonData.MarathonRaceHistory, _Mapping]]] = ...) -> None: ...
...
class BannerActivityData(_message.Message):
    __slots__ = ("activity_id", "tag_img_url", "banner_background_url", "banner_button_url", "tag_name", "start_time", "end_time", "url", "type", "sort", "need_popout")
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    TAG_IMG_URL_FIELD_NUMBER: _ClassVar[int]
    BANNER_BACKGROUND_URL_FIELD_NUMBER: _ClassVar[int]
    BANNER_BUTTON_URL_FIELD_NUMBER: _ClassVar[int]
    ...
    NEED_POPOUT_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    tag_img_url: str
    banner_background_url: str
    banner_button_url: str
    tag_name: str
    start_time: int
    end_time: int
    url: str
    ...
    sort: int
    need_popout: int
    def __init__(self, activity_id: _Optional[int] = ..., tag_img_url: _Optional[str] = ..., banner_background_url: _Optional[str] = ..., banner_button_url: _Optional[str] = ..., tag_name: _Optional[str] = ..., start_time: _Optional[int] = ..., end_time: _Optional[int] = ..., url: _Optional[str] = ..., type: _Optional[int] = ..., sort: _Optional[int] = ..., need_popout: _Optional[int] = ...) -> None: ...
...
class CustomizedContestDetail(_message.Message):
    ...
    OPEN_RANK_PERCENT_FIELD_NUMBER: _ClassVar[int]
    unique_id: int
    contest_id: int
    contest_name: str
    state: int
...
class CustomizedContestPlayerReport(_message.Message):
    __slots__ = ("rank_rule", "rank", "point", "game_ranks", "total_game_count", "rank_percent")
    RANK_RULE_FIELD_NUMBER: _ClassVar[int]
    RANK_FIELD_NUMBER: _ClassVar[int]
    POINT_FIELD_NUMBER: _ClassVar[int]
    GAME_RANKS_FIELD_NUMBER: _ClassVar[int]
    TOTAL_GAME_COUNT_FIELD_NUMBER: _ClassVar[int]
    RANK_PERCENT_FIELD_NUMBER: _ClassVar[int]
    rank_rule: int
    rank: int
    point: int
    ...
    rank_percent: int
    def __init__(self, rank_rule: _Optional[int] = ..., rank: _Optional[int] = ..., point: _Optional[int] = ..., game_ranks: _Optional[_Iterable[int]] = ..., total_game_count: _Optional[int] = ..., rank_percent: _Optional[int] = ...) -> None: ...

class Error(_message.Message):
    __slots__ = ("code", "u32_params", "str_params", "json_param", "level", "message", "args")
    ...
    message: str
    args: str
    def __init__(self, code: _Optional[int] = ..., u32_params: _Optional[_Iterable[int]] = ..., str_params: _Optional[_Iterable[str]] = ..., json_param: _Optional[str] = ..., level: _Optional[int] = ..., message: _Optional[str] = ..., args: _Optional[str] = ...) -> None: ...
...
class MMOActivityTeamCandidateData(_message.Message):
    __slots__ = ("character_id", "equipments", "id")
    CHARACTER_ID_FIELD_NUMBER: _ClassVar[int]
    EQUIPMENTS_FIELD_NUMBER: _ClassVar[int]
    ID_FIELD_NUMBER: _ClassVar[int]
    character_id: int
    equipments: _containers.RepeatedScalarFieldContainer[int]
    id: int
    def __init__(self, character_id: _Optional[int] = ..., equipments: _Optional[_Iterable[int]] = ..., id: _Optional[int] = ...) -> None: ...
...
class MarathonGameRecord(_message.Message):
    __slots__ = ("point", "distance", "used_tick")
    POINT_FIELD_NUMBER: _ClassVar[int]
    DISTANCE_FIELD_NUMBER: _ClassVar[int]
    USED_TICK_FIELD_NUMBER: _ClassVar[int]
    point: int
    distance: int
    used_tick: int
    def __init__(self, point: _Optional[int] = ..., distance: _Optional[int] = ..., used_tick: _Optional[int] = ...) -> None: ...
...
class RecordSubmit(_message.Message):
    __slots__ = ("submits",)
    SUBMITS_FIELD_NUMBER: _ClassVar[int]
    submits: _containers.RepeatedCompositeFieldContainer[SubmitInfo]
    def __init__(self, submits: _Optional[_Iterable[_Union[SubmitInfo, _Mapping]]] = ...) -> None: ...

class RecordTake(_message.Message):
    __slots__ = ("takes", "tingpais0", "tingpai", "operation")
    class TingPai(_message.Message):
        __slots__ = ("seat", "tingpais1")
        SEAT_FIELD_NUMBER: _ClassVar[int]
        TINGPAIS1_FIELD_NUMBER: _ClassVar[int]
    ...
    takes: _containers.RepeatedCompositeFieldContainer[TakeInfo]
    tingpais0: _containers.RepeatedCompositeFieldContainer[TingPaiDiscardInfo]
    tingpai: _containers.RepeatedCompositeFieldContainer[RecordTake.TingPai]
    operation: OptionalOperationList
    def __init__(self, takes: _Optional[_Iterable[_Union[TakeInfo, _Mapping]]] = ..., tingpais0: _Optional[_Iterable[_Union[TingPaiDiscardInfo, _Mapping]]] = ..., tingpai: _Optional[_Iterable[_Union[RecordTake.TingPai, _Mapping]]] = ..., operation: _Optional[_Union[OptionalOperationList, _Mapping]] = ...) -> None: ...
...
class ReqCompleteActivityFlipTaskBatch(_message.Message):
    __slots__ = ("task_list",)
    TASK_LIST_FIELD_NUMBER: _ClassVar[int]
    task_list: _containers.RepeatedScalarFieldContainer[int]
...
class ReqCreateYostarV4SDKOrder(_message.Message):
    __slots__ = ("goods_id", "client_type", "account_id", "order_type", "client_version_string")
    GOODS_ID_FIELD_NUMBER: _ClassVar[int]
    CLIENT_TYPE_FIELD_NUMBER: _ClassVar[int]
    ACCOUNT_ID_FIELD_NUMBER: _ClassVar[int]
...
class ReqFetchBannerActivityData(_message.Message):
    __slots__ = ("activity_id_list", "lang")
    ACTIVITY_ID_LIST_FIELD_NUMBER: _ClassVar[int]
    LANG_FIELD_NUMBER: _ClassVar[int]
    activity_id_list: _containers.RepeatedScalarFieldContainer[int]
    lang: str
    def __init__(self, activity_id_list: _Optional[_Iterable[int]] = ..., lang: _Optional[str] = ...) -> None: ...
...
class ReqMMOActivityDebugSetTeamCandidate(_message.Message):
    __slots__ = ("activity_id", "friend_list", "random_friends", "npc_list")
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    FRIEND_LIST_FIELD_NUMBER: _ClassVar[int]
    RANDOM_FRIENDS_FIELD_NUMBER: _ClassVar[int]
    NPC_LIST_FIELD_NUMBER: _ClassVar[int]
    ...
    random_friends: _containers.RepeatedCompositeFieldContainer[MMOActivityTeamCandidateData]
    npc_list: _containers.RepeatedCompositeFieldContainer[MMOActivityTeamCandidateData]
    def __init__(self, activity_id: _Optional[int] = ..., friend_list: _Optional[_Iterable[_Union[MMOActivityTeamCandidateData, _Mapping]]] = ..., random_friends: _Optional[_Iterable[_Union[MMOActivityTeamCandidateData, _Mapping]]] = ..., npc_list: _Optional[_Iterable[_Union[MMOActivityTeamCandidateData, _Mapping]]] = ...) -> None: ...

class ReqMMOActivityEquipFusion(_message.Message):
    __slots__ = ("activity_id", "equip_list", "target_type")
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    EQUIP_LIST_FIELD_NUMBER: _ClassVar[int]
    TARGET_TYPE_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    equip_list: _containers.RepeatedScalarFieldContainer[int]
    target_type: int
    def __init__(self, activity_id: _Optional[int] = ..., equip_list: _Optional[_Iterable[int]] = ..., target_type: _Optional[int] = ...) -> None: ...

class ReqMMOActivityFetchData(_message.Message):
    __slots__ = ("activity_id",)
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    def __init__(self, activity_id: _Optional[int] = ...) -> None: ...

class ReqMMOActivityFinishBattle(_message.Message):
    __slots__ = ("activity_id",)
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    def __init__(self, activity_id: _Optional[int] = ...) -> None: ...

class ReqMMOActivityReceiveSupportReward(_message.Message):
    __slots__ = ("activity_id",)
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    def __init__(self, activity_id: _Optional[int] = ...) -> None: ...

class ReqMMOActivitySetCharacter(_message.Message):
    __slots__ = ("activity_id", "character_id")
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    CHARACTER_ID_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    character_id: int
    def __init__(self, activity_id: _Optional[int] = ..., character_id: _Optional[int] = ...) -> None: ...

class ReqMMOActivitySetEquip(_message.Message):
    __slots__ = ("activity_id", "equipments")
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    EQUIPMENTS_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    equipments: _containers.RepeatedScalarFieldContainer[int]
    def __init__(self, activity_id: _Optional[int] = ..., equipments: _Optional[_Iterable[int]] = ...) -> None: ...

class ReqMMOActivitySetTeamMember(_message.Message):
    __slots__ = ("activity_id", "members")
    class MMOActivityTeamMember(_message.Message):
        __slots__ = ("character_id", "id", "type")
        CHARACTER_ID_FIELD_NUMBER: _ClassVar[int]
        ID_FIELD_NUMBER: _ClassVar[int]
        TYPE_FIELD_NUMBER: _ClassVar[int]
        character_id: int
        id: int
        type: int
        def __init__(self, character_id: _Optional[int] = ..., id: _Optional[int] = ..., type: _Optional[int] = ...) -> None: ...
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    MEMBERS_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    members: _containers.RepeatedCompositeFieldContainer[ReqMMOActivitySetTeamMember.MMOActivityTeamMember]
    def __init__(self, activity_id: _Optional[int] = ..., members: _Optional[_Iterable[_Union[ReqMMOActivitySetTeamMember.MMOActivityTeamMember, _Mapping]]] = ...) -> None: ...

class ReqMMOActivityStartBattle(_message.Message):
    __slots__ = ("activity_id",)
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    def __init__(self, activity_id: _Optional[int] = ...) -> None: ...

class ReqMMOActivityUpdatehFriendList(_message.Message):
    __slots__ = ("activity_id",)
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    def __init__(self, activity_id: _Optional[int] = ...) -> None: ...

class ReqMarathonActivityFinishRace(_message.Message):
    __slots__ = ("activity_id", "race_data", "record", "race_id")
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    RACE_DATA_FIELD_NUMBER: _ClassVar[int]
    RECORD_FIELD_NUMBER: _ClassVar[int]
    RACE_ID_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    race_data: _containers.RepeatedCompositeFieldContainer[ActivityMarathonCheckData]
    record: MarathonGameRecord
    race_id: str
    def __init__(self, activity_id: _Optional[int] = ..., race_data: _Optional[_Iterable[_Union[ActivityMarathonCheckData, _Mapping]]] = ..., record: _Optional[_Union[MarathonGameRecord, _Mapping]] = ..., race_id: _Optional[str] = ...) -> None: ...

class ReqMarathonActivityStartRace(_message.Message):
    __slots__ = ("activity_id",)
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    activity_id: int
    def __init__(self, activity_id: _Optional[int] = ...) -> None: ...
...
class ReqOpenChest(_message.Message):
    __slots__ = ("chest_id", "count", "use_ticket", "choose_up_activity_id", "choose_group_activity_id")
    CHEST_ID_FIELD_NUMBER: _ClassVar[int]
    COUNT_FIELD_NUMBER: _ClassVar[int]
    USE_TICKET_FIELD_NUMBER: _ClassVar[int]
    CHOOSE_UP_ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    CHOOSE_GROUP_ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    chest_id: int
    count: int
    use_ticket: bool
    choose_up_activity_id: int
    choose_group_activity_id: int
    def __init__(self, chest_id: _Optional[int] = ..., count: _Optional[int] = ..., use_ticket: _Optional[bool] = ..., choose_up_activity_id: _Optional[int] = ..., choose_group_activity_id: _Optional[int] = ...) -> None: ...
...
class ReqReceiveActivityFlipTaskBatch(_message.Message):
    __slots__ = ("task_list",)
    TASK_LIST_FIELD_NUMBER: _ClassVar[int]
    task_list: _containers.RepeatedScalarFieldContainer[int]
    def __init__(self, task_list: _Optional[_Iterable[int]] = ...) -> None: ...
...
class ReqSelectChestChooseGroupActivity(_message.Message):
...
class ReqSetActivityBuff(_message.Message):
    __slots__ = ("buff_list", "activity_id")
    ...
    BUFF_LIST_FIELD_NUMBER: _ClassVar[int]
    ACTIVITY_ID_FIELD_NUMBER: _ClassVar[int]
    buff_list: _containers.RepeatedCompositeFieldContainer[ReqSetActivityBuff.BuffInfo]
    activity_id: int
    def __init__(self, buff_list: _Optional[_Iterable[_Union[ReqSetActivityBuff.BuffInfo, _Mapping]]] = ..., activity_id: _Optional[int] = ...) -> None: ...
...
class ReqYostarDeleteAccount(_message.Message):
    __slots__ = ("server",)
...
class ResAccountActivityData(_message.Message):
    __slots__ = ("error", "exchange_records", "task_progress_list", "accumulated_point_list", "rank_data_list", "flip_task_progress_list", "sign_in_data", "richman_data", "period_task_progress_list", "random_task_progress_list", "chest_up_data", "sns_data", "mine_data", "rpg_data", "arena_data", "feed_data", "segment_task_progress_list", "vote_records", "spot_data", "friend_gift_data", "upgrade_data", "gacha_data", "simulation_data", "combining_data", "village_data", "festival_data", "island_data", "story_data", "choose_up_data", "progress_reward_data", "quest_crew_data", "shoot_data", "bingo_data", "snowball_data", "marathon_data", "choose_group_up_data", "mmo_data")
    ...
    BINGO_DATA_FIELD_NUMBER: _ClassVar[int]
    SNOWBALL_DATA_FIELD_NUMBER: _ClassVar[int]
    MARATHON_DATA_FIELD_NUMBER: _ClassVar[int]
    CHOOSE_GROUP_UP_DATA_FIELD_NUMBER: _ClassVar[int]
    MMO_DATA_FIELD_NUMBER: _ClassVar[int]
    error: Error
...
class ResCompleteActivityFlipTaskBatch(_message.Message):
    __slots__ = ("error", "total_rewards")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    TOTAL_REWARDS_FIELD_NUMBER: _ClassVar[int]
    error: Error
    total_rewards: _containers.RepeatedCompositeFieldContainer[ExecuteReward]
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., total_rewards: _Optional[_Iterable[_Union[ExecuteReward, _Mapping]]] = ...) -> None: ...
...
class ResCreateYostarV4SDKOrder(_message.Message):
    __slots__ = ("error", "order_id", "notify_url", "extra_data")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    ORDER_ID_FIELD_NUMBER: _ClassVar[int]
    NOTIFY_URL_FIELD_NUMBER: _ClassVar[int]
    EXTRA_DATA_FIELD_NUMBER: _ClassVar[int]
    error: Error
    order_id: str
    notify_url: str
    extra_data: str
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., order_id: _Optional[str] = ..., notify_url: _Optional[str] = ..., extra_data: _Optional[str] = ...) -> None: ...
...
class ResFetchBannerActivityData(_message.Message):
    __slots__ = ("error", "activity_list")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    ACTIVITY_LIST_FIELD_NUMBER: _ClassVar[int]
    error: Error
    activity_list: _containers.RepeatedCompositeFieldContainer[BannerActivityData]
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., activity_list: _Optional[_Iterable[_Union[BannerActivityData, _Mapping]]] = ...) -> None: ...
...
class ResFetchContestPlayerRank(_message.Message):
    ...
    class SeasonRank(_message.Message):
        __slots__ = ("account_id", "nickname", "data", "team_name", "modify_score", "rank", "rank_percent")
        ACCOUNT_ID_FIELD_NUMBER: _ClassVar[int]
        NICKNAME_FIELD_NUMBER: _ClassVar[int]
        DATA_FIELD_NUMBER: _ClassVar[int]
        TEAM_NAME_FIELD_NUMBER: _ClassVar[int]
        ...
        rank: int
        rank_percent: int
        def __init__(self, account_id: _Optional[int] = ..., nickname: _Optional[str] = ..., data: _Optional[_Union[ResFetchContestPlayerRank.ContestPlayerAccountData, _Mapping]] = ..., team_name: _Optional[str] = ..., modify_score: _Optional[int] = ..., rank: _Optional[int] = ..., rank_percent: _Optional[int] = ...) -> None: ...
    class PlayerData(_message.Message):
        __slots__ = ("rank", "data", "team_name", "modify_score", "rank_percent")
        RANK_FIELD_NUMBER: _ClassVar[int]
        DATA_FIELD_NUMBER: _ClassVar[int]
        TEAM_NAME_FIELD_NUMBER: _ClassVar[int]
        MODIFY_SCORE_FIELD_NUMBER: _ClassVar[int]
        ...
        modify_score: int
        rank_percent: int
        def __init__(self, rank: _Optional[int] = ..., data: _Optional[_Union[ResFetchContestPlayerRank.ContestPlayerAccountData, _Mapping]] = ..., team_name: _Optional[str] = ..., modify_score: _Optional[int] = ..., rank_percent: _Optional[int] = ...) -> None: ...
    ERROR_FIELD_NUMBER: _ClassVar[int]
...
class ResFetchContestTeamRank(_message.Message):
    ...
    class SeasonTeamRank(_message.Message):
        __slots__ = ("team_id", "name", "data", "rank", "rank_percent")
        TEAM_ID_FIELD_NUMBER: _ClassVar[int]
        NAME_FIELD_NUMBER: _ClassVar[int]
        DATA_FIELD_NUMBER: _ClassVar[int]
        RANK_FIELD_NUMBER: _ClassVar[int]
        ...
        rank: int
        rank_percent: int
        def __init__(self, team_id: _Optional[int] = ..., name: _Optional[str] = ..., data: _Optional[_Union[ResFetchContestTeamRank.ContestTeamData, _Mapping]] = ..., rank: _Optional[int] = ..., rank_percent: _Optional[int] = ...) -> None: ...
    ERROR_FIELD_NUMBER: _ClassVar[int]
    TOTAL_FIELD_NUMBER: _ClassVar[int]
    RANK_FIELD_NUMBER: _ClassVar[int]
...
class ResMMOActivityDebugSetTeamCandidate(_message.Message):
    __slots__ = ("error", "changes")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    CHANGES_FIELD_NUMBER: _ClassVar[int]
    error: Error
    changes: ActivityMMODataChanges
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., changes: _Optional[_Union[ActivityMMODataChanges, _Mapping]] = ...) -> None: ...

class ResMMOActivityEquipFusion(_message.Message):
    __slots__ = ("error", "result", "changes")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    RESULT_FIELD_NUMBER: _ClassVar[int]
    CHANGES_FIELD_NUMBER: _ClassVar[int]
    error: Error
    result: int
    changes: ActivityMMODataChanges
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., result: _Optional[int] = ..., changes: _Optional[_Union[ActivityMMODataChanges, _Mapping]] = ...) -> None: ...

class ResMMOActivityFetchData(_message.Message):
    __slots__ = ("error", "mmo_data")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    MMO_DATA_FIELD_NUMBER: _ClassVar[int]
    error: Error
    mmo_data: ActivityMMOData
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., mmo_data: _Optional[_Union[ActivityMMOData, _Mapping]] = ...) -> None: ...

class ResMMOActivityFinishBattle(_message.Message):
    ...
    changes: ActivityMMODataChanges
    rewards: _containers.RepeatedCompositeFieldContainer[ExecuteReward]
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., changes: _Optional[_Union[ActivityMMODataChanges, _Mapping]] = ..., rewards: _Optional[_Iterable[_Union[ExecuteReward, _Mapping]]] = ...) -> None: ...

class ResMMOActivityReceiveSupportReward(_message.Message):
    __slots__ = ("error", "rewards", "changes", "support_count", "total_support_count")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    REWARDS_FIELD_NUMBER: _ClassVar[int]
    CHANGES_FIELD_NUMBER: _ClassVar[int]
    SUPPORT_COUNT_FIELD_NUMBER: _ClassVar[int]
    TOTAL_SUPPORT_COUNT_FIELD_NUMBER: _ClassVar[int]
    error: Error
    rewards: _containers.RepeatedCompositeFieldContainer[ExecuteReward]
    changes: ActivityMMODataChanges
    support_count: int
    total_support_count: int
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., rewards: _Optional[_Iterable[_Union[ExecuteReward, _Mapping]]] = ..., changes: _Optional[_Union[ActivityMMODataChanges, _Mapping]] = ..., support_count: _Optional[int] = ..., total_support_count: _Optional[int] = ...) -> None: ...

class ResMMOActivitySetCharacter(_message.Message):
    __slots__ = ("error", "changes")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    CHANGES_FIELD_NUMBER: _ClassVar[int]
    error: Error
...
class ResMMOActivitySetEquip(_message.Message):
    __slots__ = ("error", "changes")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    CHANGES_FIELD_NUMBER: _ClassVar[int]
    error: Error
...
class ResMMOActivitySetTeamMember(_message.Message):
    __slots__ = ("error", "changes")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    CHANGES_FIELD_NUMBER: _ClassVar[int]
    error: Error
...
class ResMMOActivityStartBattle(_message.Message):
    __slots__ = ("error", "actions", "units", "changes", "result")
    class MMOActivityBattleAction(_message.Message):
        __slots__ = ("type", "target", "value", "tick", "critical")
        TYPE_FIELD_NUMBER: _ClassVar[int]
        TARGET_FIELD_NUMBER: _ClassVar[int]
        FROM_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        ...
        tick: int
        critical: int
        def __init__(self, type: _Optional[int] = ..., target: _Optional[int] = ..., value: _Optional[int] = ..., tick: _Optional[int] = ..., critical: _Optional[int] = ..., **kwargs) -> None: ...
    class MMOActivityBattleUnit(_message.Message):
        __slots__ = ("id", "hp", "equipments")
        ID_FIELD_NUMBER: _ClassVar[int]
        HP_FIELD_NUMBER: _ClassVar[int]
        EQUIPMENTS_FIELD_NUMBER: _ClassVar[int]
        id: int
        hp: int
        equipments: _containers.RepeatedScalarFieldContainer[int]
        def __init__(self, id: _Optional[int] = ..., hp: _Optional[int] = ..., equipments: _Optional[_Iterable[int]] = ...) -> None: ...
    ERROR_FIELD_NUMBER: _ClassVar[int]
    ACTIONS_FIELD_NUMBER: _ClassVar[int]
    ...
    RESULT_FIELD_NUMBER: _ClassVar[int]
    error: Error
    actions: _containers.RepeatedCompositeFieldContainer[ResMMOActivityStartBattle.MMOActivityBattleAction]
    units: _containers.RepeatedCompositeFieldContainer[ResMMOActivityStartBattle.MMOActivityBattleUnit]
    changes: ActivityMMODataChanges
    result: int
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., actions: _Optional[_Iterable[_Union[ResMMOActivityStartBattle.MMOActivityBattleAction, _Mapping]]] = ..., units: _Optional[_Iterable[_Union[ResMMOActivityStartBattle.MMOActivityBattleUnit, _Mapping]]] = ..., changes: _Optional[_Union[ActivityMMODataChanges, _Mapping]] = ..., result: _Optional[int] = ...) -> None: ...

class ResMMOActivityUpdatehFriendList(_message.Message):
    __slots__ = ("error", "friend_list", "random_friends", "npc_list", "expire_time", "changes")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    FRIEND_LIST_FIELD_NUMBER: _ClassVar[int]
    RANDOM_FRIENDS_FIELD_NUMBER: _ClassVar[int]
    NPC_LIST_FIELD_NUMBER: _ClassVar[int]
    ...
    expire_time: int
    changes: ActivityMMODataChanges
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., friend_list: _Optional[_Iterable[_Union[MMOActivityTeamCandidateData, _Mapping]]] = ..., random_friends: _Optional[_Iterable[_Union[MMOActivityTeamCandidateData, _Mapping]]] = ..., npc_list: _Optional[_Iterable[_Union[MMOActivityTeamCandidateData, _Mapping]]] = ..., expire_time: _Optional[int] = ..., changes: _Optional[_Union[ActivityMMODataChanges, _Mapping]] = ...) -> None: ...
...
class ResMarathonActivityFinishRace(_message.Message):
    __slots__ = ("error", "highest_record", "rewards")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    HIGHEST_RECORD_FIELD_NUMBER: _ClassVar[int]
    REWARDS_FIELD_NUMBER: _ClassVar[int]
    error: Error
    highest_record: MarathonGameRecord
    rewards: _containers.RepeatedCompositeFieldContainer[ExecuteReward]
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., highest_record: _Optional[_Union[MarathonGameRecord, _Mapping]] = ..., rewards: _Optional[_Iterable[_Union[ExecuteReward, _Mapping]]] = ...) -> None: ...

class ResMarathonActivityStartRace(_message.Message):
    __slots__ = ("error", "random_seed", "race_id")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    RANDOM_SEED_FIELD_NUMBER: _ClassVar[int]
    RACE_ID_FIELD_NUMBER: _ClassVar[int]
    error: Error
    random_seed: int
    race_id: str
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., random_seed: _Optional[int] = ..., race_id: _Optional[str] = ...) -> None: ...
...
class ResReceiveActivityFlipTaskBatch(_message.Message):
    __slots__ = ("error", "count")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    COUNT_FIELD_NUMBER: _ClassVar[int]
    error: Error
    count: int
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., count: _Optional[int] = ...) -> None: ...
...
class ResYostarDeleteAccount(_message.Message):
    __slots__ = ("error", "notify_url")
    ERROR_FIELD_NUMBER: _ClassVar[int]
    NOTIFY_URL_FIELD_NUMBER: _ClassVar[int]
    error: Error
    notify_url: str
    def __init__(self, error: _Optional[_Union[Error, _Mapping]] = ..., notify_url: _Optional[str] = ...) -> None: ...
...
class SubmitGroup(_message.Message):
    __slots__ = ("count", "tiles")
    COUNT_FIELD_NUMBER: _ClassVar[int]
    TILES_FIELD_NUMBER: _ClassVar[int]
    count: int
    tiles: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, count: _Optional[int] = ..., tiles: _Optional[_Iterable[str]] = ...) -> None: ...

class SubmitInfo(_message.Message):
    __slots__ = ("submit_seat", "groups")
    SUBMIT_SEAT_FIELD_NUMBER: _ClassVar[int]
    GROUPS_FIELD_NUMBER: _ClassVar[int]
    submit_seat: int
    groups: _containers.RepeatedCompositeFieldContainer[SubmitGroup]
    def __init__(self, submit_seat: _Optional[int] = ..., groups: _Optional[_Iterable[_Union[SubmitGroup, _Mapping]]] = ...) -> None: ...

class TakeInfo(_message.Message):
    __slots__ = ("take_seat", "from_seat", "count", "tiles")
    TAKE_SEAT_FIELD_NUMBER: _ClassVar[int]
    FROM_SEAT_FIELD_NUMBER: _ClassVar[int]
    COUNT_FIELD_NUMBER: _ClassVar[int]
    TILES_FIELD_NUMBER: _ClassVar[int]
    take_seat: int
    from_seat: int
    count: int
    tiles: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, take_seat: _Optional[int] = ..., from_seat: _Optional[int] = ..., count: _Optional[int] = ..., tiles: _Optional[_Iterable[str]] = ...) -> None: ...
